...
MONGODB_URI = "mongodb+srv://rahulrajsundararaajan_db_user:9QjgeN8KAilxbCPz@cluster0.xcyqd1v.mongodb.net/?appName=Cluster0"
...
adminEmail = 'admin@gtec.edu'
adminPassword = b'Admin@GTEC2024'

existing_admin = db.users.find_one({'email': adminEmail})
if not existing_admin:
    hashed = bcrypt.hashpw(adminPassword, bcrypt.gensalt())
    admin_user = {
...
if db.questions.count_documents({}) == 0:
    for q in SAMPLE_QUESTIONS:
        q['_id'] = 'q-' + str(uuid.uuid4())[:8]
        q['createdBy'] = '00000000-admin-0000-0000-000000000000'
        q['createdAt'] = datetime.datetime.utcnow().isoformat() + 'Z'
